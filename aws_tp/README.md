...
3.  **Configuration des étapes du pipeline dans le `Jenkinsfile` :**
    [Voir le fichier Jenkinsfile ici](./my-web-app/Jenkinsfile)

4.  **Enregistrement et exécution du pipeline :**
